...
MAX_VAMT="2"
RAND_VPOS=""
MAX_SPD="3"   # headroom over target (1.4) so the outside USV
              # can hold station through the target's turns
MMOD=""
...
#------------------------------------------------------------
#  Part 6.4: Launch the simulated target (intruder) vessel
#------------------------------------------------------------
...
#------------------------------------------------------------
#  Part 6.5: Launch the Mothership community
#------------------------------------------------------------
MARGS=" --auto --mport=9005 --pshare=9205 --shore_pshare=9200 "
MARGS+=" $TIME_WARP $JUST_MAKE $VERBOSE "
MARGS+=" $MMOD "
vecho "Launching mothership: $MARGS"
./launch_mothership.sh $MARGS

#------------------------------------------------------------
#  Part 7: Launch the Shoreside mission file
#------------------------------------------------------------
SARGS=" --auto --mport=9000 --pshare=9200 $NOGUI --vnames=abe:ben:target "
